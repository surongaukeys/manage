...
function(a) {
    ...
    n.prototype.initPagination = function() {
        ...
        var q = [c('<span class="btn-group %s">', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? "dropdown": "dropup"), '<button type="button" class="btn btn-default ' + (void 0 === this.options.iconSize ? "": +this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', '<div class="page-size">', n ? this.options.formatAllRows() : this.options.pageSize, "</div>", ' <div class="sel-page-div"><img class="sel-page" src="/images/new-vision/icon_search-terms_bounced.png"/></div>', "</button>", '<ul class="dropdown-menu" role="menu">'],
        ...
        function(a, b) {
        	...
        	m.push('<li class="page-number' + (b === parseInt(this.options.pageNumber) ? " active": "") + '">',
        			'<a href="javascript:void(0)">', b, "</a>", "</li>");
